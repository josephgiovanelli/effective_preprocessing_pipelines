...
def main():
    ...
    experiments_summarizer(
        pipeline=['features', 'rebalance'], toy=args.toy_example)
    experiments_summarizer(
        pipeline=['discretize', 'features'], toy=args.toy_example)
    experiments_summarizer(
        pipeline=['features', 'normalize'], toy=args.toy_example)
    experiments_summarizer(
        pipeline=['discretize', 'rebalance'], toy=args.toy_example)
