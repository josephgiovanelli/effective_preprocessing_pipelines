...
def main():
    ...
    results_map.to_csv(os.path.join(new_results_path, "pp_pipeline_study2.csv"), index=False)
    ...
    results_map = results_map.reset_index()
    results_map.to_csv(os.path.join(new_results_path, "pp_pipeline_study2_pivoted.csv"), index=False)
    ...
    fig.savefig(os.path.join(plots_path, "pp_pipeline_study2.pdf"), bbox_extra_artists=(lgd,text), bbox_inches='tight')
