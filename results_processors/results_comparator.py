...
def main():
    ...
    input_auto, input_algorithm, result_path = "results/evaluation2_3/pipeline_algorithm", "results/evaluation2_3/algorithm", "results"
    result_path = create_directory(create_directory(result_path, "summary"), "evaluation2_3")
